  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <h3>Dashboard</h3>
        <hr />
        <p>Hello <b>Admin</b>, Welcome to <b>Online Exam System Admin Panel.</b>
          You can use this interface to manage the rest of your account.</p>
        <hr />
        <div class="row dashboard-stats">
          <div class="col-lg-4 col-sm-6">
            <section class="panel panel-box">
              <div class="panel-left panel-item dash-st-1"><i class="fa fa-rocket text-large stat-icon">
                </i></div>
              <div class="panel-right panel-item bg-reverse">
                <p class="size-h1 no-margin"><?php
                                              ...
                                              echo "$n_r"; ?></p>
                <p class="text-muted no-margin"><span>Offered Courses</span></p>
              </div>
            </section>
          </div>
          <div class="col-lg-4 col-sm-6">
            <section class="panel panel-box">
              <div class="panel-left panel-item dash-st-2">
              ...
              <div class="panel-right panel-item bg-reverse">
                <p class="size-h1 no-margin"><?php
                                              ...
                                              echo "$n_row"; ?></p>
                <p class="text-muted no-margin"><span>Active Students</span></p>
              </div>
            </section>
          </div>
          <div class="col-lg-4 col-sm-6">
            <section class="panel panel-box">
              <div class="panel-left panel-item dash-st-3"><i class="fa fa-graduation-cap text-large stat-icon"></i></div>
              <div class="panel-right panel-item bg-reverse">
                <p class="size-h1 no-margin"><?php
                ...
                <p class="text-muted no-margin"><span>Published Exams</span></p>
              </div>
            </section>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="header-panel-dashboard color-1">
              <div class="pannel-box"><a href="#">
                  <h2>Users</h2>
                </a>
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="header-panel-dashboard color-2">
              <div class="pannel-box"><a href="#">
                  <h2>Questions</h2>
                </a>
                <div class="info-holder">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="header-panel-dashboard color-4">
              ...
              <ul class="panel-box-Menu">
                <li><a href="result.php">Exam Report</a></li>
                <li>
                  <a href="result.php">Student Report</a>
                </li>
              </ul>
            </div>
          </div>
